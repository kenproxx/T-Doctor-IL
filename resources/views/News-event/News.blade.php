            ...
            @if(!$listNewEvent)
                <div class="d-flex">
                    ...
                    <div class="col-md-7 pr-0">
                        <strong class="text-content-product">Dạ dày trào ngược có nguy hiểm không? Nguyên nhân và cách
                            phòng
                            ngừa Dạ dày trào ngược có nguy hiểm không?</strong>
                        <p class="text-gray mt-3">Có nhiều yếu tố đóng vai trò trong việc gây ra trào ngược dạ dày. Một
                            số
                            nguyên nhân phổ biến bao gồm tăng áp lực bên trong dạ dày, suy giảm hoạt động cơ của dạ dày,
                            tháo dỡ của cơ thực quản dạ dày, và dịch vị thừa trong dạ dày. Các yếu tố này có thể được
                            gây ra
                        ...
                        <a href="{{route('detail.new')}}">
                            <div class="d-flex border-8px">
                                ...
                                <div class="col-md-9 pr-0">
                                    ...
                                    <p class="fs-12px mt-2">Chiều qua, nhận được cuộc gọi của một đồng nghiệp, hỏi ý
                                        kiến về
                                        một cô
                                        gái bị mù mắt sau khi được tiêm chất làm đầy. Dù đã có nhiều cảnh báo trên các
                                        phương tiện
                                        truyền thông, tuy vậy, rất đáng tiếc khi vẫn còn khá nhiều cô gái trẻ trở thành
                                        nạn
                                        nhân của
                                        việc làm đẹp.</p>
