...
{{--                    <div class="div-3">--}}
{{--                        <div class="div-4">--}}
{{--                            <div class="img-wrapper"><img class="img" src="{{asset('img/recruitment/Vector.png')}}" /></div>--}}
{{--                            <div class="div-5">--}}
...
{{--                        </div>--}}
{{--                        <div class="div-4">--}}
{{--                            <div class="img-wrapper"><img class="img" src="{{asset('img/recruitment/hourglass-03.png')}}" /></div>--}}
{{--                            <div class="div-5">--}}
...
{{--                        </div>--}}
{{--                        <div class="div-4">--}}
{{--                            <div class="img-wrapper"><img class="img" src="{{asset('img/recruitment/briefcase.png')}}" /></div>--}}
{{--                            <div class="div-5">--}}
...
{{--                        </div>--}}
{{--                        <div class="div-4">--}}
{{--                            <div class="img-wrapper"><img class="img" src="{{asset('img/recruitment/Icon.png')}}" /></div>--}}
{{--                            <div class="div-5">--}}
...
{{--                        </div>--}}
{{--                        <div class="div-4">--}}
{{--                            <div class="img-wrapper"><img class="img" src="{{asset('img/recruitment/clock.png')}}" /></div>--}}
{{--                            <div class="div-5">--}}
...
{{--                            <button class="text-wrapper-5">Apply</button>--}}
{{--                        </div>--}}
                    ...
                    <div class="form-2">
                        <div class="div">
                            ...
                            <div class="div-2 d-flex">
                                <div class="div-wrapper"><div class="text-wrapper-2">CV 1</div></div>
                                <div class="div-wrapper"><div class="text-wrapper-2">CV 2</div></div>
                                <button class="div-wrapper"><i class="fa-solid fa-plus"></i></button>
                            </div>
                        </div>
                        <div class="div-3">
            ...
            <div class="row recruitment-details--text">
                <div class="col-md-8">
                    ...
                    <div class="frame">
                        <b style="font-size: 20px" class="text-wrapper">Bên mình đang cần tuyển dụng 2 BS chuyên khoa VLTL hoặc YHCT</b>
                        <div class="div">
                            <div class="div-2">
                                <b  style="font-size: 16px" class="text-wrapper-2">Job Description</b>
                                <p class="th-c-hi-n-c-c-k-thu">
                                    Thực hiện các kỹ thuật xét nghiệm phức tạp và thông thường tại phòng khám theo quy định<br />Nghiêm chỉnh
                                    thực hiện quy chế cơ quan<br />Thực hiện công việc khác theo sự phân công của lãnh đạo<br />Công việc cụ thể
                            ...
                            <div class="div-3">
                                ...
                                <p class="c-nh-n-x-t-nghi-m-c">
                                    Cử nhân Xét nghiệm (có CCHN, tối thiểu 36 tháng hành nghề)<br />Có năng lực và chuyên môn đúng với vị trí dự
                                    tuyển<br />Các vị trí chuyên môn tốt nghiệp trình độ Cao đẳng trở lên<br />Sử dụng thành thạo máy tính<br />Nhanh
                                    nhẹn, năng động, trung thực, muốn gắn bó lâu dài<br />Ưu tiên có CCHN/giao tiếp tiếng anh
                                </p>
                            </div>
                            <div class="div-3">
                                <b style="font-size: 16px" class="text-wrapper-2">Job requirements</b>
