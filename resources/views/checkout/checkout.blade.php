...
<style>
    ...
    .inputCheckAddress[type=checkbox] {
        height: 0;
        width: 0;
        visibility: hidden;
    }
    ...
    .inputCheckAddress:checked + .labelCheckAddress {
        background: #36CA68;
    }

    .inputCheckAddress:checked + .labelCheckAddress:after {
        left: calc(100% - 5px);
        transform: translateX(-100%);
    }

    .labelCheckAddress:active:after {
        width: 130px;
    }
...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div id="title" class="d-flex justify-content-center">
                    <div class="list-title">
                        <div class="list--doctor p-0">
                            <a class="back" href="{{route('home')}}"><p><i class="bi bi-arrow-left"></i><b>Payment</b>
                                </p></a>
                        </div>
                    </div>
                </div>
                <div class=m-auto">
                    <div class="form-group">
                        <label class="label-input" for="full_name">Full Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="full_name" placeholder="Tech Jock" required>
                    </div>
                    <div class="form-group">
                        <label class="label-input" for="email">Email <span class="text-danger">*</span></label>
                        <input type="email" class="form-control" id="email" placeholder="your-email@example.cpom">
                    </div>
                    <div class="form-group">
                        <label class="label-input" for="phone_number">Phone Number<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="phone_number" placeholder="0989889889" required>
                    </div>
                    <div class="form-group">
                        <label class="label-input" for="address">Address<span class="text-danger">*</span></label>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="province" placeholder="Master">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="district" placeholder="Branch">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                    ...
                    <div class="more-method mt-3">
                        ...
                        <div class="list-method">
                            ...
                            <div class="method-detail d-flex justify-content-between align-items-center method-cod">
                                <label for="vn_pay">
                                    <img src="{{ asset('/img/icon/vnpay-icon.png') }}" alt="" style="width: 24px; height: 19px">
                                    <span>Ví VNPAY</span>
                                </label>
                            ...
                            <div class="method-detail d-flex justify-content-between align-items-center method-cod">
                                <label for="master_card">
                                    <img src="{{ asset('/img/icon/master-card-icon.png') }}" alt="" style="width: 24px; height: 24px">
            ...
            <div class="col-md-4">
                <div class="m-auto">
                    <div class="product-item card d-flex justify-content-between">
                        <img src="{{ asset('/img/detail_doctor/img_doc.png') }}" alt="" style="max-width: 64px; max-height: 64px">
                        <div class="detail-product">
                            <p class="product-name">Menevit Viên Uống Hỗ Trợ Sinh Lý Nam Giới, Tăng Khả Năng Có Con 90 Viên</p>
