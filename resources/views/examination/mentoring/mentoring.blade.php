                        ...
                        <div class="div-2">
                            ...
                            <div class="row w-100">
                                <div class="col-sm-2 col text-cmt"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div class="text-wrapper-2 d-none d-md-inline-block">Comment: </div>${comment.comment_count ?? 0}</div>
                                <div class="col-sm-2 col text-cmt"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div class="text-wrapper-2 d-none d-md-inline-block">Views: </div>${comment.view_count ?? 0}</div>
                                <div class="col-auto col text-cmt"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div class="text-wrapper-2 d-none d-md-inline-block">Date: </div>${comment.created_at}</div>
                            </div>
                        </div>
                    </div>
                </div>
