    ...
    <form enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <textarea type="text" class="form-control" id="short_description_en" name="short_description_en"></textarea>
            </div>
            <div class="col-sm-4">
                <label>Short Description Lào</label>
                <textarea type="text" class="form-control" id="short_description_laos" name="short_description_laos"></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
